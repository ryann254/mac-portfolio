...
Done when:
- Every state in the plan has its own tab and opens without a server.
- Ryan has clicked through all of them.
- The changes Ryan asks for are written on this task.
Out of scope: Automated tests. There is no unit test for taste, and this file gets thrown away.
